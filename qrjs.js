...
var tooltip = d3.select("body")
    ...
    .on("mousemove", (d,i) => {
        tooltip.html(i +":00" + " Number: " + Math.round(d * 100) / 100)
...
var but1 = svg.selectAll(".button5")
    ...
    .on("click", function() {
        ...
        svg.selectAll(".casual").remove();
        svg.selectAll(".member").remove();
        casual_bar = svg.selectAll(".casual")
            .data(casual_5)
            .enter()
            .append("rect")
            .attr("x", d=>ctr-d*0.5)
        ...
        member_bar = svg.selectAll(".member")
            .data(member_5)
            .enter()
            .append("rect")
            .attr("x", ctr)
